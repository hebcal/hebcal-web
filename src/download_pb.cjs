...
proto.Download.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 57:
      var value = /** @type {boolean} */ (reader.readBool());
      msg.setArukhhashulchanyomi(value);
      break;
    case 58:
      var value = /** @type {boolean} */ (reader.readBool());
...
proto.Download.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getArukhhashulchanyomi();
  if (f) {
    writer.writeBool(
      57,
      f
...
/**
 * optional bool addAltDatesForEvents = 24;
 * @return {boolean}
 */
...
/**
 * optional bool arukhHaShulchanYomi = 57;
 * @return {boolean}
 */
proto.Download.prototype.getArukhhashulchanyomi = function() {
 ...
 * @return {!proto.Download} returns this
 */
proto.Download.prototype.setArukhhashulchanyomi = function(value) {
  return jspb.Message.setProto3BooleanField(this, 57, value);
};


/**
 * optional bool yySchottenstein = 58;
 * @return {boolean}
 */
proto.Download.prototype.getYyschottenstein = function() {
...
/**
 * optional bool shabbatMevarchim = 60;
 * @return {boolean}
 */
proto.Download.prototype.getShabbatmevarchim = function() {
...
/**
 * optional bool dirshuAmudYomi = 66;
 * @return {boolean}
 */
proto.Download.prototype.getDirshuamudyomi = function() {
