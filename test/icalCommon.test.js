...
describe('createMemo', () => {
  it('makes a Torah reading memo for Parashat ha-Shavua', () => {
    ...
    expect(createMemo(events[0], options)).toBe(
        ...
        'high priest, guilt offerings, and offerings of thanks. Moses initiates ' +
        'Aaron and Aaron’s sons for priestly service in the Tabernacle.\n\n' +
...
describe('DESCRIPTION generated by @hebcal/icalendar', () => {
  it('escapes newlines and folds long lines', () => {
    ...
    expect(lines).toEqual([
      ...
      '  offered in the Tabernacle (portable sanctuary)\\, including a meal offerin',
      ' g brought by the high priest\\, guilt offerings\\, and offerings of thanks. ',
      ' Moses initiates Aaron and Aaron’s sons for priestly service in the Taber',
      ' nacle.\\n\\nTorah: Leviticus 6:1-8:36\\nHaftarah: Malachi 3:4-24 | Shabbat Ha',
      ' Gadol\\n\\nhttps://hebcal.com/s/5753/25?us=ical&um=icalendar',
      'END:VEVENT',
    ]);
  });
  ...
  it('omits DESCRIPTION when there is no memo', () => {
    ...
    expect(lines.find((line) => line.startsWith('DESCRIPTION:'))).toBeUndefined();
  });
