...
describe('eventsToRss2', () => {
  it('generates a complete RSS 2.0 document', () => {
  ...
  it('requires mainUrl and selfUrl', () => {
    expect(() => eventsToRss2([], {})).toThrow(TypeError);
  });
});

describe('eventToRssItem2', () => {
  it('renders candles, zmanim and holiday items', () => {
  ...
  it('renders fast start/end times', () => {
...
`);
  ...
  it('renders a localized candle lighting title', () => {
...
/** Event with a memo and an off-site URL */
