...
fetch_urls $FILE "year=${YEAR}&month=x&yt=G&v=1&maj=on&min=off&mod=off&i=off&lg=en&c=off&geo=none&ny=10&nx=off&mf=off&ss=off"
update_ics_name $FILE \
    "Jewish Holidays" \
    "https:\\/\\/www.hebcal.com\\/"

FILE="jewish-holidays-all"
fetch_urls $FILE "year=${YEAR}&month=x&yt=G&v=1&maj=on&min=on&mod=on&i=off&lg=en&c=off&geo=none&ny=10&nx=on&mf=on&ss=on"
update_ics_name $FILE \
    "Jewish Holidays" \
    "https:\\/\\/www.hebcal.com\\/"

FILE="hdate-en"
fetch_urls $FILE "year=${YEAR}&month=x&yt=G&v=1&i=off&lg=en&d=on&c=off&geo=none&ny=2"
update_ics_name $FILE \
...
FILE="omer"
fetch_urls $FILE "year=${YEAR}&month=x&yt=G&v=1&o=on&i=off&lg=en&c=off&geo=none&ny=2"
update_ics_name $FILE \
    "Days of the Omer" \
    "7 weeks from the second night of Pesach to the day before Shavuot"

FILE="torah-readings-diaspora"
fetch_urls $FILE "year=${YEAR}&month=x&yt=G&v=1&s=on&i=off&lg=en&c=off&geo=none&ny=3"
update_ics_name $FILE \
    "Torah Readings (Diaspora)" \
    "Parashat ha-Shavua - Weekly Torah Portion from Hebcal"

FILE="torah-readings-israel"
fetch_urls $FILE "year=${YEAR}&month=x&yt=G&v=1&s=on&i=on&lg=en&c=off&geo=none&ny=3"
update_ics_name $FILE \
...
FILE="daf-yomi"
fetch_urls $FILE "year=${YEAR}&month=x&yt=G&v=1&F=on&i=off&lg=en&c=off&geo=none&ny=2"
update_ics_name $FILE \
    "Daf Yomi" \
